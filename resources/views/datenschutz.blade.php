...
@section('title', 'MyGrades - Datenschutz')

@section('content')
    <div class="container">
        <h1>Datenschutz</h1>
        <p>
            Wir nehmen den Schutz deiner persönlichen Daten sehr ernst. Wir halten uns dabei an eine Philosophie, wie wir sie uns auch von anderen Anbietern als Nutzer wünschen würden: Keine störende Werbung, quelloffen, sicher und privat. <br/>
            Für deine Nutzung der App MyGrades bedeutet das im Speziellen:
        </p>
        <ul>
            <li>Deine Zugangsdaten zum Notensystem deiner Hochschule werden lokal und verschlüsselt auf deinem Smartphone gespeichert.</li>
