...
@section('title', 'MyGrades - Impressum')
...
@section('content')
    <div class="container">
        ...
        <h2>Kontakt:</h2>
        <p>
            Telefon: +49152 37131873 <br/>
            E-Mail: hallo@mygrades.de
        </p>

        <h2>Quellenangaben für die verwendeten Bilder und Grafiken:</h2>
        <p><a href="https://plus.google.com/photos/+RomanNurik/albums/5941399053388172033">Nexus 5 PSD Sample by Roman Nurik</a></p>
        <p> </p>
