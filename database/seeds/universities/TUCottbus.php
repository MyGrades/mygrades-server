...
class TUCottbus extends UniversitySeeder {
    ...
    public function run()
    {
        ...
        $this->createAction($rule, UniversitySeeder::ACTION_TYPE_NORMAL, UniversitySeeder::HTTP_GET, '//form[@name="loginform"]/@action',  $url="https://qis.hs-lausitz.de/qisserver/rds?state=user&type=0&application=lsf");
        ...
        $this->createAction($rule, UniversitySeeder::ACTION_TYPE_NORMAL, UniversitySeeder::HTTP_GET, "//ul[@class='treelist']//a[contains(@href,'menuid=notenspiegel')]/@href");
