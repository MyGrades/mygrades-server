...
class FernuniHagenSeeder extends UniversitySeeder {
    ...
    public function run()
    {
        ...
        $rule = $this->createRule("1. Tabelle im QIS", UniversitySeeder::RULE_SEMESTER_FORMAT_SEMESTER, '(^\w+)\s*([0-9]+)', $overview=true);
        ...
        // create rule for second table in selection
        $rule = $this->createRule("2. Tabelle im QIS", UniversitySeeder::RULE_SEMESTER_FORMAT_SEMESTER, '(^\w+)\s*([0-9]+)', $overview=true);
