...
class FHFrankfurt extends UniversitySeeder {
    ...
    public function run()
    {
        ...
        $this->createAction($rule, UniversitySeeder::ACTION_TYPE_NORMAL, UniversitySeeder::HTTP_GET, '//form[@name="loginform"]/@action', $url = 'https://his-www.dv.fh-frankfurt.de/qisserver/rds?state=user&type=0');
